...
const ExamplePage: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-screen bg-black overflow-hidden flex flex-col">
      ...
      <div className="fixed bottom-0 left-0 w-full bg-gray-900/90 backdrop-blur-md border-t border-white/10 p-4 flex items-center justify-between z-50 shadow-2xl">
        <div className="flex items-center gap-4">
          <button 
            onClick={() => navigate('/')} 
            className="flex items-center gap-2 px-4 py-2 bg-red-600/20 hover:bg-red-600 text-red-200 hover:text-white rounded-lg transition-all"
          >
            <X size={18} />
            <span className="text-sm font-semibold">{t('playground.exit')}</span>
          </button>
        ...
        <div className="flex items-center gap-6 flex-1 max-w-3xl mx-4">
           <div className="text-mono text-blue-400 font-bold min-w-[100px] text-center text-lg font-['JetBrains_Mono']">
           ...
           <div className="relative flex-1 h-12 flex items-center group">
             ...
             {/* Visual Track */}
             <div className="w-full h-2 bg-gray-800 rounded-full overflow-hidden relative z-10 pointer-events-none">
               <div 
             ...
             {/* Thumb */}
             <div 
                className="absolute w-4 h-4 bg-white rounded-full shadow-[0_0_15px_rgba(59,130,246,0.8)] transform -translate-x-1/2 pointer-events-none z-20 transition-transform duration-75"
                style={{ left: `${progress}%` }}
             />
           </div>
           ...
           <button 
             ...
             className="p-3 bg-blue-600 hover:bg-blue-500 rounded-full text-white shadow-lg transition-all active:scale-95 flex-shrink-0"
           >
